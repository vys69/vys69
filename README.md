...
```math
\ce{$\unicode[goombafont; color:red; pointer-events: none; z-index: 5; position: fixed; left: 50dvi; top: 50dvb; width: 80dvmin; background-position: 0 0; height: 80dvmin; translate: -50% -50%; opacity: 1; background-repeat: no-repeat; background-size: 100% 100%; height: 300px; animation: 1s linear both infinite shrink-x; background-image: url('https://github.com/vys69/vys69/blob/main/ezgif-2-45a20cad34.gif?raw=true');]{x0000}$}
```
